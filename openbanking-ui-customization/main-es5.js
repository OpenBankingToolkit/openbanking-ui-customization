...
var FileUploadComponent = /** @class */ (function () {
    ...
    FileUploadComponent.prototype.isValidImageType = function (type) {
        return type === 'image/svg+xml';
    };
    FileUploadComponent.prototype.loadImageFile = function (file) {
        var _this = this;
    ...
    FileUploadComponent.prototype.loadImage = function (file, mime) {
        this.change.emit({
            file: file,
            mime: mime
        });
    };
    FileUploadComponent.prototype.dropped = function (event) {
        var _this = this;
        var droppedFile = event.files[0];
        if (droppedFile.fileEntry.isFile) {
            var fileEntry = droppedFile.fileEntry;
            fileEntry.file(function (file) { return _this.loadImageFile(file); });
        }
    };
...
var ForgerockCustomerFaviconCustomComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ForgerockCustomerFaviconCustomComponent, _super);
    function ForgerockCustomerFaviconCustomComponent(store, configService, sanitizer, http) {
        var _this = _super.call(this, store, configService, sanitizer, http) || this;
        _this.store = store;
        _this.configService = configService;
        _this.sanitizer = sanitizer;
        _this.http = http;
        _this.defaultImgSrc = "./assets/logos/favicon.svg";
        _this.stream$ = _this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_store_reducers_files__WEBPACK_IMPORTED_MODULE_5__["selectors"].selectFavicon));
        return _this;
    }
    ForgerockCustomerFaviconCustomComponent.ctorParameters = function () { return [
...
var ForgerockCustomerFaviconCustomModule = /** @class */ (function () {
    function ForgerockCustomerFaviconCustomModule() {
    }
...
var ForgerockCustomerIconContainer = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ForgerockCustomerIconContainer, _super);
    function ForgerockCustomerIconContainer(store, configService, sanitizer, http) {
        ...
        _this.sanitizer = sanitizer;
        _this.http = http;
        _this.stream$ = _this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_store_reducers_files__WEBPACK_IMPORTED_MODULE_6__["selectors"].selectIcon));
        return _this;
    }
    ForgerockCustomerIconContainer.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] },
...
var ForgerockCustomerIconCustomModule = /** @class */ (function () {
    function ForgerockCustomerIconCustomModule() {
    }
...
var ForgerockCustomerLogoContainer = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ForgerockCustomerLogoContainer, _super);
    function ForgerockCustomerLogoContainer(store, configService, sanitizer, http) {
        ...
        _this.sanitizer = sanitizer;
        _this.http = http;
        _this.stream$ = _this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_store_reducers_files__WEBPACK_IMPORTED_MODULE_6__["selectors"].selectLogo));
        return _this;
    }
    ForgerockCustomerLogoContainer.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] },
        { type: _forgerock_openbanking_ngx_common_services_forgerock_config__WEBPACK_IMPORTED_MODULE_5__["ForgerockConfigService"] },
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }
...
var ForgerockCustomerLogoCustomModule = /** @class */ (function () {
    function ForgerockCustomerLogoCustomModule() {
    }
...
var PaletteBackgroundComponent = /** @class */ (function () {
    ...
    PaletteBackgroundComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.formSubscription = this.themesControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (value) { return value !== ''; }))
            .subscribe(function (value) {
            _this.cssVarsService.applyForegroundTheme(_this.foregroundThemeObject[value === 'light' ? 'mat-light-theme-foreground' : 'mat-dark-theme-foreground']);
            _this.cssVarsService.applyBackgroundTheme(_this.backgroundThemeObject[value === 'light' ? 'mat-light-theme-background' : 'mat-dark-theme-background']);
            _this.themesControl.setValue('');
        });
    };
    PaletteBackgroundComponent.prototype.ngOnDestroy = function () {
        this.formSubscription.unsubscribe();
    };
    PaletteBackgroundComponent.prototype.getColor = function (type, color) {
        return "rgba(var(--palette-" + type + "-" + color + "), var(--palette-" + type + "-" + color + "-alpha, 1))";
    };
    PaletteBackgroundComponent.prototype.getCssVarValue = function (type, color) {
        var rgb = this.cssVarsService.getCssVarValue("--palette-" + type + "-" + color);
        var alpha = this.cssVarsService.getCssVarValue("--palette-" + type + "-" + color + "-alpha");
        return "rgba(" + rgb + ", " + (alpha || 1) + ")";
    };
    PaletteBackgroundComponent.prototype.changeColor = function (type, color, value) {
        this.cssVarsService.setCssVarValue("--palette-" + type + "-" + color, value.match(/\(([^)]+)\)/)[1]);
    };
    PaletteBackgroundComponent.ctorParameters = function () { return [
...
var PaletteSampleComponent = /** @class */ (function () {
    function PaletteSampleComponent() {
        this.cssvars = false;
    }
    PaletteSampleComponent.prototype.ngOnInit = function () { };
    PaletteSampleComponent.prototype.getColor = function (color) {
...
var PaletteComponent = /** @class */ (function () {
    ...
    PaletteComponent.prototype.ngOnInit = function () {
        ...
        this.formSubscription = this.themesControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (value) { return value !== ''; }))
            .subscribe(function (value) {
            _this.cssVarsService.applyTheme(_this.type, _this.themeObject[value]);
            _this.themesControl.setValue('');
        });
    };
    ...
    PaletteComponent.prototype.getColor = function (color) {
        return "rgba(var(--palette-" + this.type + "-" + color + "), var(--palette-" + this.type + "-" + color + "-alpha, 1))";
    };
    PaletteComponent.prototype.getCssVarValue = function (color) {
        var rgb = this.cssVarsService.getCssVarValue("--palette-" + this.type + "-" + color);
        var alpha = this.cssVarsService.getCssVarValue("--palette-" + this.type + "-" + color + "-alpha");
        return "rgba(" + rgb + ", " + (alpha || 1) + ")";
    };
    PaletteComponent.prototype.changeColor = function (color, value) {
...
var ForgerockCustomizationSidenavComponent = /** @class */ (function () {
    ...
    ForgerockCustomizationSidenavComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.customizationService.onOpen().subscribe(function (isOpened) {
            _this.isOpened = isOpened;
            _this.cdr.detectChanges();
        });
        this.metaFormSubscirption = this.metaForm.valueChanges.subscribe(function (_a) {
            var title = _a.title, description = _a.description;
            title && _this.store.dispatch(new _store_reducers_metadata__WEBPACK_IMPORTED_MODULE_6__["AddMetaTitleAction"](title));
            description &&
                _this.store.dispatch(new _store_reducers_metadata__WEBPACK_IMPORTED_MODULE_6__["AddMetaDescriptionAction"](description));
        });
        this.open();
    };
    ForgerockCustomizationSidenavComponent.prototype.ngOnDestroy = function () {
        this.metaFormSubscirption.unsubscribe();
    };
    ForgerockCustomizationSidenavComponent.prototype.close = function () {
        this.customizationService.close();
    };
    ForgerockCustomizationSidenavComponent.prototype.open = function () {
        this.customizationService.open();
    };
    ForgerockCustomizationSidenavComponent.prototype.export = function () {
        this.customizationService.export();
    };
    ForgerockCustomizationSidenavComponent.prototype.uploadLogo = function (changeObject) {
        this.store.dispatch(new _store_reducers_files__WEBPACK_IMPORTED_MODULE_5__["AddLogoAction"](changeObject));
    };
    ForgerockCustomizationSidenavComponent.prototype.uploadIcon = function (changeObject) {
        this.store.dispatch(new _store_reducers_files__WEBPACK_IMPORTED_MODULE_5__["AddIconAction"](changeObject));
    };
    ForgerockCustomizationSidenavComponent.prototype.uploadFavicon = function (changeObject) {
        this.store.dispatch(new _store_reducers_files__WEBPACK_IMPORTED_MODULE_5__["AddFaviconAction"](changeObject));
    };
    ForgerockCustomizationSidenavComponent.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] },
...
function getCustomReducers() {
    var _a;
    return _a = {},
        _a[_store_reducers_files__WEBPACK_IMPORTED_MODULE_25__["customizationFilesReducerKey"]] = _store_reducers_files__WEBPACK_IMPORTED_MODULE_25__["default"],
        _a[_store_reducers_metadata__WEBPACK_IMPORTED_MODULE_26__["customizationMetaReducerKey"]] = _store_reducers_metadata__WEBPACK_IMPORTED_MODULE_26__["default"],
        _a;
}
var ForgerockCustomizationModule = /** @class */ (function () {
    function ForgerockCustomizationModule() {
    }
    ForgerockCustomizationModule_1 = ForgerockCustomizationModule;
    ForgerockCustomizationModule.forRoot = function (config) {
        return {
...
var ForgerockCssVarsService = /** @class */ (function () {
    function ForgerockCssVarsService(_document, _config) {
        ...
        this.applyPrimaryTheme = function (theme) { return _this.injectVariables(theme, '--palette-primary'); };
        this.applyAccentTheme = function (theme) { return _this.injectVariables(theme, '--palette-accent'); };
        this.applyWarnTheme = function (theme) { return _this.injectVariables(theme, '--palette-warn'); };
        this.applyForegroundTheme = function (theme) {
            return _this.injectVariables(theme, '--palette-foreground');
        };
        this.applyBackgroundTheme = function (theme) {
            return _this.injectVariables(theme, '--palette-background');
        };
        // Keep in case the palette list changes
        // const cssVars = require('sass-extract-loader!./cssvars.scss');
        // console.log(cssVars);
    }
    Object.defineProperty(ForgerockCssVarsService.prototype, "matPalettes", {
        get: function () {
    ...
    Object.defineProperty(ForgerockCssVarsService.prototype, "matPaletteNames", {
        get: function () {
    ...
    Object.defineProperty(ForgerockCssVarsService.prototype, "foregroundPalettes", {
        get: function () {
    ...
    Object.defineProperty(ForgerockCssVarsService.prototype, "foregroundPaletteNames", {
        get: function () {
    ...
    Object.defineProperty(ForgerockCssVarsService.prototype, "backgroundPalettes", {
        get: function () {
    ...
    Object.defineProperty(ForgerockCssVarsService.prototype, "backgroundPaletteNames", {
        get: function () {
    ...
    ForgerockCssVarsService.prototype.getThemeNamesByType = function (type) {
        switch (type) {
            case 'primary':
            case 'accent':
            case 'warn':
    ...
    ForgerockCssVarsService.prototype.getThemeObjectByType = function (type) {
        switch (type) {
            case 'primary':
            case 'accent':
            case 'warn':
    ...
    ForgerockCssVarsService.prototype.getPalettePropsByType = function (type) {
        switch (type) {
            case 'primary':
            case 'accent':
            case 'warn':
    ...
    ForgerockCssVarsService.prototype.injectVariables = function (list, prefix) {
        Object.keys(list).filter(function (key) {
            return document.documentElement.style.setProperty(prefix ? prefix + "-" + key : key, list[key]);
        });
    };
    ForgerockCssVarsService.prototype.init = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, foregroundPalettes, backgroundPalettes, matPalettes, backgroundPaletteNames, foregroundPaletteNames, matPaletteNames;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this._init) return [3 /*break*/, 2];
                        this._init = true;
                        return [4 /*yield*/, __webpack_require__.e(/*! import() | cssvars-js */ "cssvars-js").then(__webpack_require__.t.bind(null, /*! ./cssvars.js */ "./src/app/customization/services/cssvars.js", 7))];
                    case 1:
                        _a = _b.sent(), foregroundPalettes = _a.foregroundPalettes, backgroundPalettes = _a.backgroundPalettes, matPalettes = _a.matPalettes, backgroundPaletteNames = _a.backgroundPaletteNames, foregroundPaletteNames = _a.foregroundPaletteNames, matPaletteNames = _a.matPaletteNames;
    ...
    ForgerockCssVarsService.prototype.applyTheme = function (type, theme) {
        if (!theme)
            return;
        switch (type) {
            case 'primary':
    ...
    ForgerockCssVarsService.prototype.getCssVarValue = function (cssVar) {
        return this._document.documentElement.style.getPropertyValue(cssVar);
    };
    ForgerockCssVarsService.prototype.setCssVarValue = function (cssVar, value) {
        var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](value.split(','), 4), r = _a[0], g = _a[1], b = _a[2], _b = _a[3], a = _b === void 0 ? '1' : _b;
    ...
    ForgerockCssVarsService.prototype.export = function () {
        var _this = this;
        return Object.values(this._document.documentElement.style).reduce(function (prev, current) {
            var _a;
            if (current.startsWith('--')) {
                return Object.assign(prev, (_a = {},
                    _a[current] = _this.getCssVarValue(current),
                    _a));
            }
            return prev;
        }, {});
    };
    ForgerockCssVarsService.ctorParameters = function () { return [
...
var ForgerockCustomizationService = /** @class */ (function () {
    function ForgerockCustomizationService(store, cssVarsService, document) {
        ...
        this.open = function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cssVarsService.init()];
                    case 1:
                        _a.sent();
        ...
        this.close = function () { return _this.isOpened$.next(false); };
        this.onOpen = function () { return _this.isOpened$; };
    }
    ForgerockCustomizationService.prototype.export = function () {
        var exportData = {};
        this.store
            ...
            .subscribe(function (state) { return (exportData.imgs = state); });
        this.store
            ...
            .subscribe(function (state) { return (exportData.metadata = state); });
    ...
    ForgerockCustomizationService.ctorParameters = function () { return [
...
var AddLogoAction = /** @class */ (function () {
    function AddLogoAction(payload) {
        this.payload = payload;
        this.type = types.ADD_LOGO;
    }
    AddLogoAction.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return AddLogoAction;
}());

var AddIconAction = /** @class */ (function () {
    function AddIconAction(payload) {
        this.payload = payload;
        this.type = types.ADD_ICON;
    }
    AddIconAction.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return AddIconAction;
}());

var AddFaviconAction = /** @class */ (function () {
    function AddFaviconAction(payload) {
        this.payload = payload;
        this.type = types.ADD_FAVICON;
    }
    AddFaviconAction.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
function customizationFilesReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case types.ADD_LOGO: {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { logo: action.payload });
        }
        case types.ADD_ICON: {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { icon: action.payload });
        }
        case types.ADD_FAVICON: {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { favicon: action.payload });
        }
        default:
            return state;
    }
...
var selectAll = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationFilesReducerKey + "]");
};
var selectLogo = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationFilesReducerKey + "].logo.file");
};
var selectIcon = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationFilesReducerKey + "].icon.file");
};
var selectFavicon = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationFilesReducerKey + "].favicon.file");
};
var selectors = {
    selectAll: selectAll,
...
var AddMetaTitleAction = /** @class */ (function () {
    function AddMetaTitleAction(payload) {
        this.payload = payload;
        this.type = types.ADD_META_TITLE;
    }
    AddMetaTitleAction.ctorParameters = function () { return [
        { type: String }
    ]; };
    return AddMetaTitleAction;
}());

var AddMetaDescriptionAction = /** @class */ (function () {
    function AddMetaDescriptionAction(payload) {
        this.payload = payload;
        this.type = types.ADD_META_DESCRIPTION;
    }
    AddMetaDescriptionAction.ctorParameters = function () { return [
        { type: String }
    ]; };
...
function customizationMetaReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        ...
        case types.ADD_META_DESCRIPTION: {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { description: action.payload });
        }
        default:
            return state;
    }
...
var selectAll = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationMetaReducerKey + "]");
};
var selectTitle = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationMetaReducerKey + "].title");
};
var selectDescription = function (state) {
    return Object(lodash_es_get__WEBPACK_IMPORTED_MODULE_1__["default"])(state, "customization[" + customizationMetaReducerKey + "].description");
};
var selectors = {
    selectAll: selectAll,
...
var ForgerockCustomizationToken = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('ForgerockCustomizationToken');
